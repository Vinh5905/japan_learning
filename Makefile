...
help:
	...
	@echo "  make db-migrate          Apply pending Prisma migrations, including standalone vocabulary tables."
	@echo "  make prisma-generate     Generate Prisma client after schema changes."
	@echo ""
	@echo "Quality checks:"
