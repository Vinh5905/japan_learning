...
// Reset all Anki saved state. This intentionally requires two confirmations
// from the client because it can delete every note in the configured Anki deck.
export async function POST(request: Request) {
  ...
  try {
    ...
    const deckFound = decks.includes(ANKI_DECK_NAME);
    let deletedNotes = 0;
